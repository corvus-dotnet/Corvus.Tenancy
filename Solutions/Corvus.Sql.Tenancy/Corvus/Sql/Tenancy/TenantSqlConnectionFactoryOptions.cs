// <copyright file="TenantSqlConnectionFactoryOptions.cs" company="Endjin Limited">
...
namespace Corvus.Sql.Tenancy
{
    ...
    public class TenantSqlConnectionFactoryOptions
    {
        ...
        /// to create an instance of <see cref="TenantSqlConnectionFactoryOptions"/> however you like. The
        ...
        /// </summary>
        public SqlConfiguration? RootTenantSqlConfiguration { get; set; }
    }
}
