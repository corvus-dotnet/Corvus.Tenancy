// <copyright file="IStorageConfigurationExtensions.cs" company="Endjin Limited">
...
namespace Corvus.Azure.Storage.Tenancy
{
    ...
    /// </summary>
    public static class IStorageConfigurationExtensions
    {
        ...
        public static string GetStorageAccountKeySecretName(this IStorageConfiguration configuration)
        {
        ...
        public static void SetStorageAccountKeySecretName(this IStorageConfiguration configuration, string accountKeySecretName)
        {
        ...
        public static string GetStorageAccountKeyConfigurationKey(this IStorageConfiguration configuration)
        {
            // First, try the configuration specific to this instance
