// <copyright file="TenantCloudTableFactoryOptions.cs" company="Endjin Limited">
...
{
    /// <summary>
    /// Configuration settings for <see cref="ITenantBlobContainerClientFactory"/>.
    /// </summary>
    public class TenantCloudTableFactoryOptions
    {
        ...
        /// </p>
        /// <code><![CDATA[
        /// services.AddTenantCloudTableFactory(configurationRoot.Get<TenantCloudTableFactoryOptions>());
        /// ]]></code>
        /// <p>
        ...
        /// to create an instance of <see cref="TenantCloudTableFactoryOptions"/> however you like. The
