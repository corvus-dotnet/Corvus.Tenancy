// <copyright file="TenantCosmosContainerFactoryOptions.cs" company="Endjin Limited">
...
namespace Corvus.Azure.Cosmos.Tenancy
{
    ...
    /// <summary>
    /// Configuration settings for <see cref="TenantCosmosContainerFactory"/>.
    /// </summary>
    public class TenantCosmosContainerFactoryOptions
    {
        /// <summary>
        ...
        /// </p>
        /// <code><![CDATA[
        /// services.AddTenantCosmosContainerFactory(configurationRoot.Get<TenantCosmosContainerFactoryOptions>());
        /// ]]></code>
        /// <p>
        ...
        /// to create an instance of <see cref="TenantCosmosContainerFactoryOptions"/> however you like. The
