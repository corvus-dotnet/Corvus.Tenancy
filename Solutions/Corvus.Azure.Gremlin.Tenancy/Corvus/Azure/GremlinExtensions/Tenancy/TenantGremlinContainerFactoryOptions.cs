// <copyright file="TenantGremlinContainerFactoryOptions.cs" company="Endjin Limited">
...
namespace Corvus.Azure.GremlinExtensions.Tenancy
{
    ...
    /// <summary>
    /// Configuration settings for <see cref="TenantGremlinContainerFactory"/>.
    /// </summary>
    public class TenantGremlinContainerFactoryOptions
    {
        /// <summary>
        ...
        /// </p>
        /// <code><![CDATA[
        /// services.AddTenantGremlinContainerFactory(configurationRoot.Get<TenantGremlinContainerFactoryOptions>());
        /// ]]></code>
        /// <p>
        ...
        /// to create an instance of <see cref="TenantGremlinContainerFactoryOptions"/> however you like. The
        ...
        /// </summary>
        public GremlinConfiguration? RootTenantGremlinConfiguration { get; set; }
    }
}
