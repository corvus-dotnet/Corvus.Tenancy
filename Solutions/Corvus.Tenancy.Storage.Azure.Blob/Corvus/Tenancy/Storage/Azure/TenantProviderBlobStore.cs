...
namespace Corvus.Tenancy
{
        ...
        : ITenantStore
    {
        ...
        /// <param name="serializerOptions">The serializer settings provider for tenant serialization.</param>
        public TenantProviderBlobStore(
            RootTenant tenant,
            IPropertyBagFactory propertyBagFactory,
            ITenantCloudBlobContainerFactory tenantCloudBlobContainerFactory,
            IJsonSerializerOptionsProvider serializerOptions)
        {
            ...
            this.serializerOptions = serializerOptions.Instance;
